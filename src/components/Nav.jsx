  ...
  return (
    <>
      ...
      >
        ...
        <MobileNav open={openNav}>
          <div className="container mx-auto">
            ...
            >
              <span>
                <a
                  href="https://res.cloudinary.com/damonjohnson/raw/upload/v1681814499/Boa_Wraps_ROI_Calculator_iarae8.xlsx"
                  download
        ...
        <div
          className="hidden lg:w-full lg:flex lg:justify-end lg:-mt-14 lg:pb-2 lg:pr-14"
          id="navbar-default"
        >
